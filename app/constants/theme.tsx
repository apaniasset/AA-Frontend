...
export const FONTS = {
	fontLg: { fontSize: SIZES.fontLg, color: COLORS.text, lineHeight: 20, fontFamily: 'Inter_18pt-Regular' },
	font: { fontSize: SIZES.font, color: COLORS.text, lineHeight: 20, fontFamily: 'Inter_18pt-Regular' },
	fontSm: { fontSize: SIZES.fontSm, color: COLORS.text, lineHeight: 18, fontFamily: 'Inter_18pt-Regular' },
	fontXs: { fontSize: SIZES.fontXs, color: COLORS.text, lineHeight: 14, fontFamily: 'Inter_18pt-Regular' },

	h1: { fontSize: SIZES.xl4, color: COLORS.title, lineHeight: 36, fontFamily: 'Inter_18pt-Regular' },
	h2: { fontSize: SIZES.xl3, color: COLORS.title, lineHeight: 32, fontFamily: 'Inter_18pt-Regular' },
	h3: { fontSize: SIZES.xl2, color: COLORS.title, lineHeight: 30, fontFamily: 'Inter_18pt-Regular' },
	h4: { fontSize: SIZES.xl, color: COLORS.title, lineHeight: 28, fontFamily: 'Inter_18pt-Regular' },
	h5: { fontSize: SIZES.l, color: COLORS.title, lineHeight: 24, fontFamily: 'Inter_18pt-Regular' },
	h6: { fontSize: SIZES.m, color: COLORS.title, lineHeight: 21, fontFamily: 'Inter_18pt-Regular' },

	BodyM: { fontSize: SIZES.m, color: COLORS.title, lineHeight: 22, fontFamily: 'Inter_18pt-Regular' },
	BodyS: { fontSize: SIZES.s, color: COLORS.title, lineHeight: 20, fontFamily: 'Inter_18pt-Regular' },
	BodyXS: { fontSize: SIZES.xs, color: COLORS.title, lineHeight: 15, fontFamily: 'Inter_18pt-Regular' },


	fontBold: { fontFamily: 'Inter_18pt-Bold' },
	fontMedium: { fontFamily: 'Inter_18pt-Medium' },
	fontTitle: { fontFamily: 'Inter_18pt-Medium' },
	fontRegular: { fontFamily: 'Inter_18pt-Regular' },
	fontSemiBold: { fontFamily: 'Inter_18pt-SemiBold' },
	fontLight: { fontFamily: 'Inter_18pt-Light' },
}
