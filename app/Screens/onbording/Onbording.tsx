        ...
        <View style={{ backgroundColor: theme.dark ? COLORS.darkwhite : COLORS.white, flex: 1 }}>
            ...
            >
                ...
                >
                    ...
                    />
                    {/* Phone Input and OTP Sections - Commented Out */}
                    {/* {!showOtp ?
                        (
                            <>
                                <View>
                                ...
                                <View style={{ marginTop: 20, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 5 }}>
                                    ...
                                    <TouchableOpacity onPress={() => navigation.navigate('PropertyTypeSelection')} activeOpacity={0.7}>
                    ...
                    {/* Only Show Create Account and Do it later buttons */}
                    <Button
                title='Create Account'
                btnRounded
                onPress={() => navigation.navigate('PropertyTypeSelection')}
            />
